...
const BentoTilt = ({ children, className = '' }) => {
    ...
    const handleMouseMove = (e) => {
        ...
        const newTransform = `perspective(700px) rotateX(${tiltY}deg) rotateY(${tiltX}deg) scale3d(1, 1, 1)`;
  ...
  return (
    <section className='bg-black pb-52'>
        ...
        <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
            <BentoTilt className='bento-til_1 row-span-1 md:col-span-1 md:row-span-2'>
            <BentoCard
