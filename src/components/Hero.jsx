...
const Hero = () => {
  ...
  return (
    <div className='relative h-dvh w-screen overflow-x-hidden'>
      ...
      <div id='video-frame' className='z-10 relative h-dvh w-screen overflow-x-hidden rounded-lg bg-blue-75'>
        <div>
        ...
        <div className='absolute left-0 top-0 z-40 size-full'>
          ...
          Unleash the Play
           ...
           <Button id="watch-trailer" title="watch Tailer" containerClass="!bg-yellow-300 flex-center gap-1" leftIcon={<TiLocationArrow/>} />
          </div>
        </div>
      </div>
